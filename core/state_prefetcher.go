...
func (p *statePrefetcher) Prefetch(block *types.Block, statedb *state.StateDB, contractSnapshots *state.StateDB, cfg vm.Config, interrupt *atomic.Bool) {
	...
	for i, tx := range block.Transactions() {
		// (re)instantiate the contract snapshot DB
